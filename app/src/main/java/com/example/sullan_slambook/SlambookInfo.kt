...
data class SlambookInfo(
    ...
    companion object CREATOR : Parcelable.Creator<SlambookInfo> {
        override fun createFromParcel(parcel: Parcel): SlambookInfo {
            return SlambookInfo(parcel)
        }

        override fun newArray(size: Int): Array<SlambookInfo?> {
